...
namespace EXPRESS {
    ...
    public partial class dsDatos : global::System.Data.DataSet {
        ...
        public partial class LoginDataTable : global::System.Data.TypedTableBase<LoginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public LoginRow AddLoginRow(int IdRol, string Nombre, string Apellidos, string Email, string Password) {
...
namespace EXPRESS.dsDatosTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Usuario] ([IdRol], [Nombre], [Apellidos], [Email], [Password]) VALUE" +
                "S (@IdRol, @Nombre, @Apellidos, @Email, @Password)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Usuario] SET [IdRol] = @IdRol, [Nombre] = @Nombre, [Apellidos] = @Apellid" +
                "os, [Email] = @Email, [Password] = @Password WHERE (([IdUsuario] = @Original_IdU" +
                "suario))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["EXPRESSConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Password", global::System.Data.SqlDbType.VarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "Password", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(dsDatos.LoginDataTable dataTable, string Email, string Password) {
        ...
        public virtual dsDatos.LoginDataTable GetData(string Email, string Password) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((Email == null)) {
                throw new global::System.ArgumentNullException("Email");
            }
        ...
        public virtual int Insert(int IdRol, string Nombre, string Apellidos, string Email, string Password) {
        ...
        public virtual int Update(int IdRol, string Nombre, string Apellidos, string Email, string Password, int Original_IdUsuario) {
